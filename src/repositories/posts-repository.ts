...
export class PostsRepository  {
    ...
    async likeOperation(id: string,userId:string,login:string,likeStatus: string): Promise<boolean> {
        ...
        if ((findUsersLikes!.length===0)&&(likeStatus==="Like")&&(post.extendedLikesInfo.myStatus==="None")){
        ...
        if ((findUsersDislikes!.length===0)&&(likeStatus==="Dislike")&&(post.extendedLikesInfo.myStatus==="None")){
